...
class FollowManager:
    ...
    def toggle_follow(self, db: Session, follower: User,
        ...
        # Auto-verify when 10k followers reached
        VERIFIED_THRESHOLD = 10000
        if following and followers_count >= VERIFIED_THRESHOLD and not target.is_verified:
            ...
            notification_manager.create(
                ...
                notif_type = "verified",
                message    = "✓ You're now verified — 10,000 followers reached!"
            )
